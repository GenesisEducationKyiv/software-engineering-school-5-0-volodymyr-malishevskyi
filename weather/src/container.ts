...
import { WeatherService, WeatherController } from './modules/weather';
...
container.registerInstance('WeatherServiceConfig', {
  baseUrl: config.weatherService.httpUrl,
});

container.registerInstance('WeatherServiceGrpcConfig', {
  address: config.weatherService.grpcUrl,
});
